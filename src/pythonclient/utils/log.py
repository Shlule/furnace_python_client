...
env_log_level = os.getenv("FURNACE_LOG_LEVEL", "DEBUG")
...
__FILE_FORMAT__ = "[FURNACE]\
    [%(asctime)s] %(levelname)s|\
    [%(module)s.%(funcName)s] %(message)-50s (%(lineno)d)"


log_path = f"{tempfile.gettempdir()}/Furnace_pythonClients_logs"  # under Windows look for %TEMP%\silex_client_logs
# print(log_path)
